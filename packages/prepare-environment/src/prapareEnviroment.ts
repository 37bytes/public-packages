...
interface PrepareEnvironmentParams {
    ...
    // configData: { pathToEnvironmentsFolder: string; allowedEnvironments: string[]; variablePrefix: string }
    cliArguments: ExtractedArguments;
}
const prepareEnvironment = ({ configData, cliArguments }: PrepareEnvironmentParams) => {
    console.log({ configData, cliArguments });
